...
class DataStorage:
    ...
    def _get_pickle_path(
        self, exchange_id: str, timeframe: str, market_type: str = "spot"
    ) -> str:
        """Get path to pickle file for exchange-timeframe-market."""
        base_filename = (
            f"{exchange_id.lower()}_{market_type.lower()}_{timeframe}.pickle"
        )
...
def save_data_pickle(
    data: vbt.Data, exchange_id: str, timeframe: str, market_type: str = "spot"
) -> bool:
