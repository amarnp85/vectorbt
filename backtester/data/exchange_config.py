...
def get_exchange_info(exchange_id: str) -> Dict[str, Any]:
    ...
    if exchange_id not in ccxt.exchanges:
        ...
        raise ValueError(f"Exchange '{exchange_id}' not found. Examples of available exchanges: {available}")
...
def data_fetching_example(symbol: str = "BTC/USDT", 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--info', metavar='EXCHANGE', help='Get information about an exchange')
    parser.add_argument('--timeframes', metavar='EXCHANGE', help='List timeframes for an exchange')
    parser.add_argument('--example', metavar='EXCHANGE', help='Show data fetching example for an exchange')
    parser.add_argument('--test', metavar='EXCHANGE', help='Test if data can be fetched from an exchange')
    ...
    # Handle info command
        ...
        try:
            ...
            print(f"Supports OHLCV data fetching: {'Yes' if info['has_fetchOHLCV'] else 'No'}")
            print(f"Requires API keys for data fetching: {info['requires_api_key_for_data']}")
    ...
    # Handle test command
        ...
        try:
            ...
            print("Attempting to fetch a small amount of data using VectorBT Pro CCXTData...")
            ...
            try:
                ...
                print(f"Data shape: {ohlcv.shape if hasattr(ohlcv, 'shape') else 'N/A'}")
            except Exception as e:
