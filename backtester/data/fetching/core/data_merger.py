    ...
    def merge_symbol_sets(
        ...
        try:
            ...
            if new_data and new_symbols:
                symbol_dict.update(
                    DataMerger._extract_symbols(new_data, new_symbols)
                )
    ...
    def _extract_symbols(
        ...
        try:
            ...
            for symbol in symbols:
                ...
                for feature, feature_df in ohlcv_data.items():
                    if feature_df is not None and symbol in feature_df.columns:
                        col_name = feature.capitalize()
                        symbol_df[col_name] = feature_df[symbol]
