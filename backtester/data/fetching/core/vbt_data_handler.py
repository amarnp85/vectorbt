...
class VBTDataHandler:
    ...
    @staticmethod
    def _extract_from_simple_columns(
        df: pd.DataFrame,
        ...
        try:
            ...
            for col in df.columns:
                ...
                if "open" in col_lower and "open" not in column_mapping:
                    ...
                    "volume" in col_lower or "vol" in col_lower
                ) and "volume" not in column_mapping:
    ...
    @staticmethod
    def get_symbol_data(
        data: vbt.Data, symbol: str, feature: str = "close"
    ) -> Optional[pd.Series]:
        """
    ...
    @staticmethod
    def get_date_range(
        data: vbt.Data, symbol: Optional[str] = None
